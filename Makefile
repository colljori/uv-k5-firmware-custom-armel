...
ifeq ($(ENABLE_FEAT_F4HWN),1)
	...
	AUTHOR_STRING_3 ?= JOTA
	VERSION_STRING_3 ?= v0.1.2

	AUTHOR_STRING ?= $(AUTHOR_STRING_1)+$(AUTHOR_STRING_2)+$(AUTHOR_STRING_3)
	VERSION_STRING ?= $(VERSION_STRING_3)
else
...
ifeq ($(ENABLE_BITMAP_WELCOME),1)
	CFLAGS  += -DENABLE_BITMAP_WELCOME
endif
